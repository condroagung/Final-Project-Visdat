...
def map_tab(map_data, states):
    ...
    def make_dataset(carrier_list):
        ...
        for carrier in carrier_list:
            ...
            sub_carrier = subset[subset['carrier']
                                 ['Unnamed: 3_level_1'] == carrier]
    ...
    def make_plot(src, xs, ys):
        ...
        p = figure(plot_width=1100, plot_height=700,
                   title='Map of 2013 Flight Delays Departing NYC')
    ...
    def update(attr, old, new):
        ...
        carrier_list = [carrier_selection.labels[i]
